...
const createText = async (req, res, next) => {
  try {
    ...
    const text = await karchagTextService.create({
      ...
      yeshe_de_volume_length: yeshe_de_volume_length || null,
      tibetan_title,
      ...
      bampo_number: bampo_number ?? null,
      page_count: page_count ?? null,
      interpretation: interpretation || null,
      pitaka_type: pitaka_type || null,
      pedurma_volume_number: pedurma_volume_number || null,
      sermon: sermon || null,
      yana: yana || null,
