  ...
  return (
    <Card className="flex flex-col h-full overflow-hidden hover:shadow-md transition-shadow">
      <div className="overflow-hidden h-48 relative">
        <img 
          src={video.thumbnailUrl || "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=2574&auto=format&fit=crop"} 
      ...
      <CardHeader className="pb-2">
        ...
        {video.tibetanTitle && (
          <p className="text-sm font-medium text-kangyur-maroon tibetan">{video.tibetanTitle}</p>
        )}
      </CardHeader>
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Manage Video Content</h1>
