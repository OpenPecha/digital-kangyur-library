...
const NewsCard = ({ news }: { news: NewsEntry }) => {
  return (
    <Card className="flex flex-col h-full overflow-hidden hover:shadow-md transition-shadow">
      <div className="overflow-hidden h-48">
        <img 
          src={news.thumbnailUrl || "https://images.unsplash.com/photo-1598499255807-87188c4eda38?q=80&w=2574&auto=format&fit=crop"} 
          alt={news.englishTitle}
      ...
      <CardHeader className="pb-2">
        ...
        {news.tibetanTitle && (
          <p className="text-sm font-medium text-kangyur-maroon tibetan">{news.tibetanTitle}</p>
        )}
      </CardHeader>
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Manage News Content</h1>
