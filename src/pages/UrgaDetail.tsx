        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-kangyur-maroon">
              <span className="language-en">Urga Kangyur Online</span>
              <span className="language-tibetan tibetan ml-2">ཨུར་ག་བཀའ་འགྱུར་དྲ་ཐོག</span>
            </h1>
            <p className="mt-2 text-kangyur-dark/80">
              <span className="language-en">Browse the digitized version of the Urga Kangyur, produced in Mongolia and notable for its unique texts.</span>
              <span className="language-tibetan tibetan block mt-1">ཨུར་ག་བཀའ་འགྱུར་ནི་སོག་ཡུལ་དུ་བཞེངས་པ་ཞིག་ཡིན་ལ། དེའི་ནང་དམིགས་བསལ་གྱི་གཞུང་དང་དཔེ་ཚན་མི་འདྲ་བ་བཞུགས་པས་མཚན་སྙན་ཆེ།</span>
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-kangyur-orange/20 shadow-sm overflow-hidden">
            <div className="w-full h-[calc(100vh-300px)] min-h-[600px]">
              <iframe 
                src="https://library.bdrc.io/show/bdr:W29468#open-viewer" 
                className="w-full h-full border-0"
                title="Urga Kangyur Online Viewer"
                allowFullScreen
              />
            </div>
          </div>
