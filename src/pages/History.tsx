  ...
  events: {
    ...
    <div className="flex flex-col gap-2 mb-6">
      <h2 className="text-2xl font-bold text-kangyur-dark">
        ...
        {tibetanPeriod && <span className="language-tibetan tibetan ml-2">{tibetanPeriod}</span>}
      </h2>
      <p className="text-lg text-kangyur-dark/60">{timeframe}</p>
    </div>
    <div className="pl-6 border-l-2 border-kangyur-maroon/20">
      {events.map((event, index) => <div key={index} className="relative mb-8 last:mb-0">
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <TimelineItem period="Early Translation Period" tibetanPeriod="སྔ་འགྱུར།" timeframe="7th-9th centuries" events={[{
          year: "7th-8th",
          ...
          <TimelineItem period="Dark Age and Revival" timeframe="9th-11th centuries" events={[{
          year: "842-978",
          ...
          <TimelineItem period="Proto-Kangyur Formation" timeframe="11th-13th centuries" events={[{
          year: "1076",
          ...
          <TimelineItem period="First Structured Kangyurs" timeframe="13th-14th centuries" events={[{
          year: "1310",
          ...
          <TimelineItem period="Classic Manuscript Kangyurs" timeframe="14th-15th centuries" events={[{
          year: "1380-1410",
          ...
          <TimelineItem period="Block-Printed Editions" timeframe="15th century onward" events={[{
          year: "1410",
          ...
          <TimelineItem period="Modern Period" timeframe="20th century onward" events={[{
          year: "1909",
